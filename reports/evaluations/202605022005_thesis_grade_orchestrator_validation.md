...
- Node-power exporter check `reports/evaluations/202605030520_node_power_exporter_availability.md` found no Kepler/RAPL/IPMI/DCGM/direct power exporter in the current Kind validation cluster.
