...
Multi-family gate suite: `reports/evaluations/202605030320_aiopslab_multi_family_policy_gate_suite.json` records `status=passed` with `4/4` held-out entries passing across Hotel Reservation Prometheus mitigation, SocialNetwork target-port full-phase validation, SocialNetwork scale-to-zero full-phase validation, and SocialNetwork assign-to-nonexistent-node full-phase validation.
Repeated-seed PPO statistics: `reports/evaluations/202605030350_repeated_seed_ppo_summary.md` records `3/3` passing seeds for Hotel Reservation Prometheus mitigation, SocialNetwork target-port full-phase validation, SocialNetwork scale-to-zero full-phase validation, and SocialNetwork assign-to-nonexistent-node full-phase validation.
